...
# File paths
data_folder_file_path = "C:/Users/DAQ-User/Documents/LabVIEW Data/3Loop/run 1/"
physical_data_path = data_folder_file_path + "filtered_data.csv"
model_data_path = data_folder_file_path + "model_data.csv"
anomaly_data_path = data_folder_file_path + "anomaly.csv"
...
class AnomalyPlotterApp:
    ...
    def update_plot(self):
        ...
        current_file_size = os.path.getsize(anomaly_data_path)

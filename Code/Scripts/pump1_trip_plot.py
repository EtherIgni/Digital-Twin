...
# File paths
data_folder = "C:/Users/james/Documents/repo/Digital-Twin/Code/Data/trip_pump1"
...
physical_data = physical_data[24:820,:]
print(physical_data[0,0])
model_data[:, 0] -= model_data[0, 0]
model_data = model_data[4:800,:]
anomaly_data[:, 0] -= anomaly_data[0, 0]
anomaly_data = anomaly_data[4:800,:]
...
event_start = 372  # Example time for the vertical bar
event_end   = 526
